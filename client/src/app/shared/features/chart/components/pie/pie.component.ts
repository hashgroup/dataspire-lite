...
export class PieComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  private onClickChart($event): void {
    this.clicked.emit({type: $event.type, value: $event.target.dataItem.properties.category});
  }
  ...
  ngAfterViewInit(): void {
    ...
    this.browserOnly(() => {
      ...
      series.slices.template.events.on("hit", this.onClickChart.bind(this), this);
      series.slices.template.events.on("hidden", this.onClickChart.bind(this), this);
      series.slices.template.events.on("shown", this.onClickChart.bind(this), this);
